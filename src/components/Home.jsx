...
const Home = () => {
    return (
        <div id='home' className='align-middle bg-slate-200 h-96 text-gray-900 dark:bg-slate-600 dark:text-slate-200 sm:h-96 grid grid-flow-row place-content-center px-5 mt-24 mb-40'>
